...
<div class="form-row">
    ...
    <div class="input-box">
       <?= $this->Form->input('product_est_yield',['required'=>true, 'class'=>'input-field small integer','label'=>false]); ?>

       <?php  echo $this->Form->input('product_est_yield1', ['required'=>true, 'options'=>$est_yield, 'label'=>false, 'selected'=>'12', 'class'=>'input-field est-yield-select']); 
       ?>
...
<div class="input-box add-printer-image"><input type="file" name="product_image[]" id="product_image" onchange="addreadURL(this);" ><img alt="your image" src="/DBR/images/img-add-printer-image.gif" id="printer-image" required="true">
</div>
