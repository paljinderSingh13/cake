...
////_______________Keyword COmma Separator ________________//
$("#tags input").on({
    focusout : function() {
...
//alert('old img')
  ...
  //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            //alert(x);
            $(wrapper).append('<div class="form-row"><div class="label-field">Image:</div><div class="input-box add-printer-image"><input type="file" name="product_image[]" id="product_image_'+x+'" onchange="readURL(this);" ><img alt="your image" src="/DBR/images/img-add-printer-image.gif" id="printer-image" required="true"></div><a href="#" class="btn remove_field">Remove</a></div>'); //add input box
        }
if(x==max_fields){
     ...
     <?= $this->Form->input('product_waiver_charges',['required'=>true, 'class'=>'input-field integer','label'=>false]); ?>
            ...
            <input type="hidden" id="imgcount" value="1" >
             ...
             <div class="input_fields_wrap">
                <div class="form-row">
                    <div class="label-field">Image:</div><div class="input-box add-printer-image">
