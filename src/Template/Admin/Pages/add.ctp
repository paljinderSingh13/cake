	...
	tinyMCE.init({
        ...
        <div class="white-wrapper">
        	<div class="page-head clearfix">
            	<h2><img src="<?php echo $this->Url->build('/');?>images/icon-pencil.png" width="28" height="29" alt=""> Add Page</h2>
            </div>
            <div class="form">
 <?=  $this->Form->create('',['type'=>'file','id'=>'addition-user']); ?>
                <div class="form-row">
                	<div class="label-field" style="float:left;"></div>
                    <div class="input-box">
                    <?= $this->Form->input('page_title',['class'=>'input-field','label'=>false,'value'=>'']); ?>
                   </div>
                </div>
